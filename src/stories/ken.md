...
Coming from Singapore, my first days in Australia were definitely a {% bold "struggle" %}. The culture of small talk felt jarring — having to say “how are you?” to strangers gave me {% bold "anxiety" %}, because in my culture, we’re not used to that kind of openness, especially with people we don’t know. On top of that, I often felt {% bold "misunderstood" %} or {% bold "left out" %} in conversations with locals, since they spoke quickly and there was a clear {% bold "disconnect" %} in the way we communicated. I definitely felt the {% bold "pressure" %} to assimilate, not only because one of my goals in coming to Australia was to get more {% highlight "comfortable" %} with conversation, but also because I didn’t want to be in another country without immersing myself in its culture. I started to feel more at {% highlight "ease" %} when I began working part-time and made friends who were locals, which helped me adjust and build {% highlight "confidence" %}. Now, I’m much more {% highlight "comfortable" %} with small talks and I’m definitely more open with the things I talk about.
