...
{% question "Has the media you consumed changed over time?" %}
...
With the global popularity of Korean culture has come easier access, not just for me, but for everyone. It’s both {% bold "strange" %} and {% highlight "comforting" %} when I’m able to connect with someone who has no Korean background over a shared interest in K-pop or K-dramas. Personally, I haven’t noticed much change in how people perceive me, but my dad’s experiences have been different.

He told me that when meeting new colleagues, some people initially act indifferent or neutral toward him. But once they hear his accent or see his Korean last name, their behaviour would change completely. They’d suddenly become more friendly and start talking about how much they love K-dramas, Korean food, or Korean culture in general. In one instance, someone said they assumed he was Chinese, which made me reflect on how casual {% bold "xenophobia" %} can still be, a topic of its own.

In some ways, the global popularity of Korean culture has had a positive impact for him. When he first moved to Australia in the 1990s, he often faced {% bold "discrimination" %} for being Asian. Now, he sometimes receives warmth or admiration simply for being Korean. I have {% bold "mixed feelings" %} about that though. It’s unsettling that people’s attitudes can shift based solely on ethnicity. Yet at the same time, I feel a quiet sense of {% highlight "pride" %} and {% highlight "happiness" %} that people are engaging with and appreciating my culture. It’s a complicated, almost surreal experience.
...
Even so, I don’t feel a strong need to immerse myself in Australian content. Australia’s {% highlight "multicultural" %} nature allows me to find communities and people with shared interests without feeling {% bold "pressured" %} to assimilate into one cultural narrative. That said, I often imagine creating a show that reflects the everyday life of a Korean Australian or any second-generation immigrant in Australia, where the story isn’t centred solely on culture or difference. Instead, it would simply portray someone navigating life like anyone else, who just happens to come from an immigrant family. Sometimes, Australian shows with characters of colour focus so heavily on their cultural identity that it ends up highlighting their “{% bold "otherness" %}.” It would be refreshing to see someone like me or many of my friends, represented as ordinary, complex individuals, not defined only by their background.

{% question "Are there any stereotypes about Koreans or Asians in media that you find yourself internalising, questioning, or resisting?" %}

Recently, there has been a noticeable increase in reports of Korean tourists causing trouble in various Southeast Asian countries and earning the unfortunate label of the “{% bold "Americans of Asia" %}.” These incidents often involve arguments, disrespectful behaviours, or mistreatment of locals. Similarly, when foreigners visit Korea, cases of {% bold "racism" %} and {% bold "discrimination" %} sometimes surface.

I can’t ignore the {% bold "racism" %} that exists within parts of the Korean community, it’s genuinely {% bold "disheartening" %} and, at times, {% bold "embarrassing" %}. Considering Korea’s own history of hardship and suffering only about seventy years ago, I would have expected a greater sense of empathy and understanding toward others. Instead, with the global rise of Korean culture, it seems some Koreans have developed a kind of {% bold "misplaced" %} pride or {% bold "superiority" %} complex, which can manifest as prejudice or arrogance.

This is one of the few aspects of being Korean that makes me feel {% bold "conflicted" %}. Of course, not all Koreans behave this way, there are countless stories of foreigners meeting incredibly kind and welcoming locals. Yet the increasing visibility of negative encounters raises uncomfortable questions for me about what it truly means to be Korean, and how I reconcile {% highlight "pride" %} in my heritage with criticism of its flaws.

{% question "What is the one thing that helps you the most when it comes to being proud and accepting of your cultural identity?" %}

I’ve come to accept that I’ll never be 100% Korean or 100% Australian, and I’m {% highlight "comfortable" %} with that. A Korean coworker once asked how I identify myself: Korean or Australian? My answer was “Korean Australian.” I’m an Australian citizen with Korean heritage, so it feels {% highlight "natural" %} to exist within a blend of both cultures—a kind of “{% highlight "new culture" %}” of my own.
In Korean, there’s a term for people like me: gyopo (교포), meaning ethnic Koreans living abroad. In the past, this word often carried negative connotations, suggesting {% bold "disconnection" %} from one’s cultural roots. But I chose to {% highlight "embrace" %} it. I identify myself {% highlight "proudly" %} as a gyopo, someone who can experience the best of both worlds and continuously learn from both cultures.
