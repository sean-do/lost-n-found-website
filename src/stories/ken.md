...
Up until I was about 13, most of what I mostly consumed Eastern media, from K-pop to Taiwanese TV shows. But also around that age, I started discovering more Western content and began gravitating towards it, from YouTube personalities to music. That shift gradually shaped my mindset, and I started to see Western ways of thinking as somewhat {% bold "superior" %} to Eastern ones. I unconsciously prioritised consuming more Western media, dreaming about traveling to Western countries, etc. At the time, I didn’t think I was {% bold "avoiding" %} connecting with my heritage Chinese culture. But looking back now, I can see that there was a clear shift in my mindset which might have quietly {% bold "distanced" %} me from it.

As I grew older, while still consuming Western media, I {% highlight "rekindled" %} my relationship with Eastern media and began appreciating its values again. When I moved to Australia from Singapore, that was when I really started prioritising my {% highlight "connection" %} with my heritage culture. Being away from home made me realise how much I had taken it for granted. Since then, I’ve made it a top priority to not lose connection with my heritage culture.

{% question "How was your experience when you first came to Australia?" %}

Coming from Singapore, my first days in Australia were definitely a {% bold "struggle" %}. The culture of small talk felt jarring — having to say “how are you?” to strangers gave me {% bold "anxiety" %}, because in my culture, we’re not used to that kind of openness, especially with people we don’t know. On top of that, I often felt {% bold "misunderstood" %} or {% bold "left out" %} in conversations with locals, since they spoke quickly and there was a clear {% bold "disconnect" %} in the way we communicated. I definitely felt the {% bold "pressure" %} to assimilate, not only because one of my goals in coming to Australia was to get more {% highlight "comfort" %}able with conversation, but also because I didn’t want to be in another country without immersing myself in its culture. I started to feel more at {% highlight "ease" %} when I began working part-time and made friends who were locals, which helped me adjust and build {% highlight "confidence" %}. Now, I’m much more {% highlight "comfort" %}able with small talks and I’m definitely more open with the things I talk about.
